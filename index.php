...
?>
                        ...
                        <div class="slider-banner">
                            <div class="home-slider-main-6">
                                <div class="home6-slider owl-carousel owl-theme">
                                    <div class="items">
                                        <div class="img-back" style="background-image:url(image/slider15.jpg);">
                                            <div class="h-s-content">
                                                <span class="slider-name">Top selling!</span>
                                                <h1>Super broccoli<br> from $9.00</h1>
                                                <a href="grid-list.html" class="btn btn-style1"><span>Shop now</span></a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="items">
                                        <div class="img-back" style="background-image:url(image/slider17.jpg);">
                                            <div class="h-s-content">
                                                <span class="slider-name">Top selling!</span>
                                                <h1>Otas ata pasta<br> 20% off</h1>
                                                <a href="grid-list.html" class="btn btn-style1"><span>Shop now</span></a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="items">
                                        <div class="img-back" style="background-image:url(image/slider16.jpg);">
                                            <div class="h-s-content">
                                                <span class="slider-name">Flat lay of plate!</span>
                                                <h1>Fish and clams<br> seafoods</h1>
                                                <a href="grid-list.html" class="btn btn-style1"><span>Shop now</span></a>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="top-banner">
                                <div class="right-banner">
                                    <a href="grid-list.html" class="r-banner">
                                        <img src="image/banner23.jpg" class="img-fluid" alt="banner-image">
                                    </a>
                                    <div class="banner-r-content1">
                                        <span class="banner-sale">Fresh vegetable</span>
                                        <h2>Veg chilli <br><span class="banner-off">start from $9</span></h2>
                                        <a href="grid-list.html" class="banner-shop1">Shop now <i class="fa fa-angle-right"></i></a>
                                    </div>
                                </div>
                                <div class="right-banner">
                                    <a href="grid-list.html" class="r-banner">
                                        <img src="image/banner24.jpg" class="img-fluid" alt="banner-image">
                                    </a>
                                    <div class="banner-r-content2">
                                        <span>Fried rice</span>
                                        <h2>Served with<br> chili fish sauce</h2>
                                        <a href="grid-list.html" class="banner-shop2">Shop now <i class="fa fa-angle-right"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <!-- service start -->
        <section class="service-section section-tb-padding">
            <div class="container">
                <div class="row">
                    <div class="col">
                        <div class="service">
                    ...
                    <div class="col">
                        ...
                        <div class="category-6">
                            <div class="cate-6 owl-carousel owl-theme">
                                <div class="items">
                                    <div class="cate-back" style="background-image: url(image/category-image/home-6/image1.jpg);">
                                        <div class="cat-box">
                                            <h2>Fresh fruits</h2>
                                            <ul class="category-link">
                                                <li><a href="grid-list.html"><i class="fa fa-angle-right"></i>Farmer orange</a></li>
                                                <li><a href="grid-list.html"><i class="fa fa-angle-right"></i>Vege guava</a></li>
                                                <li><a href="grid-list.html"><i class="fa fa-angle-right"></i>Special lithci</a></li>
                                                <li><a href="grid-list.html"><i class="fa fa-angle-right"></i>Green almond</a></li>
                                                <li><a href="grid-list.html"><i class="fa fa-angle-right"></i>Organic banana</a></li>
                                                <li><a href="grid-list.html"><i class="fa fa-angle-right"></i>Healthy papaya</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                <div class="items">
                                    <div class="cate-back" style="background-image: url(image/category-image/home-6/image2.jpg);">
                                        <div class="cat-box">
                                            <h2>Dairy & chesse</h2>
                                            <ul class="category-link">
                                                <li><a href="grid-list.html"><i class="fa fa-angle-right"></i>Farmer milk 1ltr</a></li>
                                                <li><a href="grid-list.html"><i class="fa fa-angle-right"></i>Organic bread</a></li>
                                                <li><a href="grid-list.html"><i class="fa fa-angle-right"></i>Farmer milkshek</a></li>
                                                <li><a href="grid-list.html"><i class="fa fa-angle-right"></i>Mengo butter</a></li>
                                                <li><a href="grid-list.html"><i class="fa fa-angle-right"></i>Organic honey</a></li>
                                                <li><a href="grid-list.html"><i class="fa fa-angle-right"></i>Butter milk 0.5ltr</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                <div class="items">
                                    <div class="cate-back" style="background-image: url(image/category-image/home-6/image3.jpg);">
                                        <div class="cat-box">
                                            <h2>Fresh vegetable</h2>
                                            <ul class="category-link">
                                                <li><a href="grid-list.html"><i class="fa fa-angle-right"></i>Fresh onion</a></li>
                                                <li><a href="grid-list.html"><i class="fa fa-angle-right"></i>Vege potato</a></li>
                                                <li><a href="grid-list.html"><i class="fa fa-angle-right"></i>Organic tomato</a></li>
                                                <li><a href="grid-list.html"><i class="fa fa-angle-right"></i>Fresh carrot</a></li>
                                                <li><a href="grid-list.html"><i class="fa fa-angle-right"></i>Natural grasbeen</a></li>
                                                <li><a href="grid-list.html"><i class="fa fa-angle-right"></i>Spe kakadi</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                <div class="items">
                                    <div class="cate-back" style="background-image: url(image/category-image/home-6/image4.jpg);">
                                        <div class="cat-box">
                                            <h2>Organic juice</h2>
                                            <ul class="category-link">
                                                <li><a href="grid-list.html"><i class="fa fa-angle-right"></i>Lime coffee</a></li>
                                                <li><a href="grid-list.html"><i class="fa fa-angle-right"></i>Hindustan tea</a></li>
                                                <li><a href="grid-list.html"><i class="fa fa-angle-right"></i>Chili coffee</a></li>
                                                <li><a href="grid-list.html"><i class="fa fa-angle-right"></i>Spe butter coffee</a></li>
                                                <li><a href="grid-list.html"><i class="fa fa-angle-right"></i>Grass coffee</a></li>
                                                <li><a href="grid-list.html"><i class="fa fa-angle-right"></i>Orange wine coffee</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                <div class="items">
                                    <div class="cate-back" style="background-image: url(image/category-image/home-6/image5.jpg);">
                                        <div class="cat-box">
                                            <h2>Sea & fish</h2>
                                            <ul class="category-link">
                                        ...
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <div class="tab-product">
                                                    ...
                                                    <div class="tab-caption">
                                                        <h3><a href="product-style-6.html">Fresh litchi 100% organic</a></h3>
                                                        <div class="rating">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="tab-product">
                                                    ...
                                                    <div class="tab-caption">
                                                        <h3><a href="product-style-6.html">Fresh dryed almod (50gm)</a></h3>
                                                        <div class="rating">
                                                            <i class="fa fa-star e-star"></i>
                                                            <i class="fa fa-star e-star"></i>
                                                            <i class="fa fa-star e-star"></i>
                                            ...
                                            <div class="swiper-slide">
                                                <div class="tab-product">
                                                    ...
                                                    <div class="tab-caption">
                                                        <h3><a href="product-style-6.html">Fresh apple</a></h3>
                                                        <div class="rating">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="tab-product">
                                                    ...
                                                    <div class="tab-caption">
                                                        <h3><a href="product-style-6.html">Vegetable tomato fresh</a></h3>
                                                        <div class="rating">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="tab-product">
                                                    ...
                                                    <div class="tab-caption">
                                                        <h3><a href="product-style-6.html">Natural grassbean</a></h3>
                                                        <div class="rating">
                                                            <i class="fa fa-star c-star"></i>
                                                            <i class="fa fa-star c-star"></i>
                                                            <i class="fa fa-star c-star"></i>
                                            ...
                                            <div class="swiper-slide">
                                                <div class="tab-product">
                                                    ...
                                                    <div class="tab-caption">
                                                        <h3><a href="product-style-6.html">Orange juice (5ltr)</a></h3>
                                                        <div class="rating">
                                                            <i class="fa fa-star b-star"></i>
                                                            <i class="fa fa-star b-star"></i>
                                                            <i class="fa fa-star-o"></i>
                                            ...
                                            <div class="swiper-slide">
                                                <div class="tab-product">
                                                    ...
                                                    <div class="tab-caption">
                                                        <h3><a href="product-style-6.html">Organic coconet (5ltr) juice</a></h3>
                                                        <div class="rating">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="tab-product">
                                                    ...
                                                    <div class="tab-caption">
                                                        <h3><a href="product-style-6.html">Shrimp jumbo (5Lb)</a></h3>
                                                        <div class="rating">
                                                            <i class="fa fa-star c-star"></i>
                                                            <i class="fa fa-star c-star"></i>
                                                            <i class="fa fa-star c-star"></i>
                                        ...
                                        <div class="swiper-wrapper">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="tab-product">
                                                    ...
                                                    <div class="tab-caption">
                                                        <h3><a href="product-style-6.html">Fresh organic fruit (50gm)</a></h3>
                                                        <div class="rating">
                                                            <i class="fa fa-star c-star"></i>
                                                            <i class="fa fa-star c-star"></i>
                                                            <i class="fa fa-star c-star"></i>
                                            ...
                                            <div class="swiper-slide">
                                                <div class="tab-product">
                                                    ...
                                                    <div class="tab-caption">
                                                        <h3><a href="product-style-6.html">Fresh & healty food</a></h3>
                                                        <div class="rating">
                                                            <i class="fa fa-star e-star"></i>
                                                            <i class="fa fa-star e-star"></i>
                                                            <i class="fa fa-star e-star"></i>
        ...
        <section class="testimonial-6 section-tb-padding">
            <div class="container">
                <div class="row">
                    <div class="col">
                        <div class="section-title3">
                            <h2><span>Purchasing power parity</span></h2>
                        </div>
                        <div class="testi-6 owl-carousel owl-theme">
                                ...
                                <div class="testimonial-content">
                                    <div class="testimonial-area">
                                        <div class="testi-name">
                                            <span class="tsti-title">By disarak</span>
                                            <span>
                                                <i class="fa fa-star e-star"></i>
                                                <i class="fa fa-star e-star"></i>
                                                <i class="fa fa-star e-star"></i>
                                    ...
                                    <p>“ I love this theme. Higly customizable, Easy to use and very flexible theme. Great support ! Excellent response times. Very professional and helpf...</p>
                                    <h6>Flexibility</h6>
                                </div>
                            </div>
                            <div class="items">
                                <div class="testimonial-content">
                                    <div class="testimonial-area">
                                        <div class="testi-name">
                                            <span class="tsti-title">By cremica_Foods</span>
                                            <span>
                                                <i class="fa fa-star e-star"></i>
                                                <i class="fa fa-star e-star"></i>
                                                <i class="fa fa-star e-star"></i>
                            ...
                            <div class="items">
                                <div class="testimonial-content">
                                    <div class="testimonial-area">
                                        <div class="testi-name">
                                            <span class="tsti-title">By sametin8</span>
                                            <span>
                                                <i class="fa fa-star e-star"></i>
                                                <i class="fa fa-star e-star"></i>
                                                <i class="fa fa-star e-star"></i>
                            ...
                            <div class="items">
                                <div class="testimonial-content">
                                    <div class="testimonial-area">
                                        <div class="testi-name">
                                            <span class="tsti-title">By amirzano</span>
                                            <span>
                                                <i class="fa fa-star e-star"></i>
                                                <i class="fa fa-star e-star"></i>
                                                <i class="fa fa-star e-star"></i>
                            ...
                            <div class="items">
                                <div class="testimonial-content">
                                    <div class="testimonial-area">
                                        <div class="testi-name">
                                            <span class="tsti-title">By nestheboza</span>
                                            <span>
                                                <i class="fa fa-star e-star"></i>
                                                <i class="fa fa-star e-star"></i>
                                                <i class="fa fa-star e-star"></i>
        ...
        <section class="featured-product-6 section-b-padding">
            <div class="container">
                <div class="row">
                    <div class="col">
                        <div class="section-title3">
                        ...
                        <div class="home6-featured owl-carousel owl-theme">
                            ...
                            <div class="items">
                                ...
                                <div class="caption">
                                    <h3><a href="product-style-6.html">Sp.red fresh guava</a></h3>
                                    <div class="rating">
                                        <i class="fa fa-star d-star"></i>
                                        <i class="fa fa-star d-star"></i>
                                        <i class="fa fa-star d-star"></i>
                            ...
                            <div class="items">
                                ...
                                <div class="caption">
                                    <h3><a href="product-style-6.html">Fresh mussel (500g)</a></h3>
                                    <div class="rating">
                                        <i class="fa fa-star d-star"></i>
                                        <i class="fa fa-star d-star"></i>
                                        <i class="fa fa-star d-star"></i>
        ...
        <!-- blog start -->
        <section class="home-6-blog section-tb-padding">
            <div class="container">
                <div class="row">
                    <div class="col">
                        <div class="section-title3">
                                    ...
                                    <div class="blog-start">
                                        <div class="blog-image">
                                            ...
                                            <div class="image-link">
                                                <a href="blog-style-6-left-3-grid.html">Garlic</a>
                                                <a href="blog-style-6-left-3-grid.html">Tost</a>
                                            </div>
                                        </div>
                                ...
                                <div class="items">
                                    <div class="blog-start">
                                        <div class="blog-image">
                                            ...
                                            <div class="image-link">
                                                <a href="blog-style-6-left-3-grid.html">Haldi</a>
                                                <a href="blog-style-6-left-3-grid.html">Masala</a>
                                            </div>
                                        </div>
                                        <div class="blog-content">
                                            <div class="blog-title">
                                ...
                                <div class="items">
                                    <div class="blog-start">
                                        <div class="blog-image">
                                            ...
                                            <div class="image-link">
                                                <a href="blog-style-6-left-3-grid.html">Green</a>
                                                <a href="blog-style-6-left-3-grid.html">Paper</a>
                                            </div>
                                        </div>
                                        <div class="blog-content">
                                            <div class="blog-title">
                                ...
                                <div class="items">
                                    <div class="blog-start">
                                        <div class="blog-image">
                                            ...
                                            <div class="image-link">
                                                <a href="blog-style-6-left-3-grid.html">Indian</a>
                                                <a href="blog-style-6-left-3-grid.html">Masala</a>
                                            </div>
                                        </div>
                                        <div class="blog-content">
                                ...
                                <div class="items">
                                    <div class="blog-start">
                                        <div class="blog-image">
                                            ...
                                            <div class="image-link">
                                                <a href="blog-style-6-left-3-grid.html">Garlic</a>
                                                <a href="blog-style-6-left-3-grid.html">Vagetable</a>
                                            </div>
                                        </div>
                                        <div class="blog-content">
                                            <div class="blog-title">
                                ...
                                <div class="items">
                                    <div class="blog-start">
                                        <div class="blog-image">
                                            ...
                                            <div class="image-link">
                                                <a href="blog-style-6-left-3-grid.html">Freshmeat</a>
                                                <a href="blog-style-6-left-3-grid.html">Organic</a>
                                            </div>
                                        </div>
                                        <div class="blog-content">
                                            <div class="blog-date-comment">
                                                <div class="blog-title">
                                                    <h6><a href="blog-style-6-details.html">Vegist special liquide fresh vegetable</a></h6>
                                                </div>
                                                <p class="blog-description">Lorem ipsum dolor sit amet, consectetuer adipiscing elit doli. Aenean commodo ligula eget dolor...</p>
                                                <div class="more-blog">
                                                    <a href="blog-style-6-details.html" class="read-link">
                    ...
                    <div class="col">
                        <div class="b-news">
                            <div class="full-banner">
                                <a href="grid-list.html" class="f-b">
                                    <img src="image/home-6.jpg" class="img-fluid" alt="banner-image">
                                </a>
                                <div class="banner-content">
                                    <span class="b-slogan">Top view pasta</span>
                            ...
                            <div class="latest-deal">
                                <div class="news-l" style="background-image: url(image/news-6.jpg);">
                                    <div class="news-content">
                                        ...
                                        <form>
                                            ...
                                            <a href="javascript:void(0)"><i class="ion-paper-airplane"></i></a>
                                        </form>
                                        <ul class="news-icn">
                            ...
                            <div class="f-logo">
                                <ul class="footer-ul">
                                    <li class="footer-li footer-logo">
                                        <a href="index6.html">
                                            <img class="img-fluid" src="image/logo4.png" alt="">
                                        </a>
                                        <p>Tortor neque egestas augue, eu vulputate magna eros eu erat.</p>
                                    </li>
                                    <li>
                                        <a href="javascript:void(0)"><img src="image/payment.png" class="img-fluid" alt="pay-image"></a>
                                    </li>
                                </ul>
                            </div>
                                ...
                                <div class="footer-link" id="footer-accordian">
                                    <div class="f-link">
                                        ...
                                        <ul class="f-link-ul collapse" id="t-search" data-bs-parent="#footer-accordian">
                                            <li class="f-link-ul-li"><a href="product-style-6.html">Fruits</a></li>
                                            <li class="f-link-ul-li"><a href="product-style-6.html">Fast food</a></li>
                                            <li class="f-link-ul-li"><a href="product-style-6.html">Vegetable</a></li>
                                            <li class="f-link-ul-li"><a href="product-style-6.html">Salads</a></li>
                                            <li class="f-link-ul-li"><a href="product-style-6.html">Bestseller</a></li>
                                        </ul>
                                    </div>
                                    <div class="f-link">
                    ...
                    <div class="col">
                        <ul class="f-bottom">
                            <li class="f-c f-copyright">
                                <p>Copyright <i class="fa fa-copyright"></i> 2024 spacingtech rights reserved</p>
                            </li>
                        </ul>
                    </div>
                </div>
                        ...
                        <div class="popup-content">
                            ...
                            <div class="pop-up-newsletter" style="background-image: url(image/news-popup.jpg);">
                                <div class="logo-content">
                                    <a href="index6.html"><img src="image/logo4.png" alt="image" class="img-fluid"></a>
                                ...
                                <div class="subscribe-area">
                                    ...
                                    <a href="index6.html" class="btn btn-style1"><span>Subscribe</span></a>
                                </div>
                            </div>
